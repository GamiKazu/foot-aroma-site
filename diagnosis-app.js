(() => {
  ...
  app.innerHTML = `
    <style>
      .dq-hero,.dq-form-section,.dq-result-section{padding:88px 0}.dq-hero{padding:0;background:transparent;overflow:hidden}.dq-hero>.container{width:100%;max-width:none;padding:0}
      ...
      .dq-hero-card{max-width:none;padding:0;overflow:hidden;background:transparent;border:0;border-radius:0;box-shadow:none}
